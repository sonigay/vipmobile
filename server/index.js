  ...
  try {
    ...
    if (targetSheet) {
      ...
      if (existingData.length === 0) {
        ...
        const initialData = [
          headers,
          ['합계', '합계', '가입자수', ...Array(24).fill(0)],
          ['합계', '합계', '관리수수료', ...Array(24).fill(0)],
          ['306891', '경수', '가입자수', ...Array(24).fill(0)],
          ['306891', '경수', '관리수수료', ...Array(24).fill(0)],
          ['315835', '경인', '가입자수', ...Array(24).fill(0)],
          ['315835', '경인', '관리수수료', ...Array(24).fill(0)],
          ['316558', '동서울', '가입자수', ...Array(24).fill(0)],
          ['316558', '동서울', '관리수수료', ...Array(24).fill(0)],
          ['314942', '호남', '가입자수', ...Array(24).fill(0)],
          ['314942', '호남', '관리수수료', ...Array(24).fill(0)],
          ['316254', '호남2', '가입자수', ...Array(24).fill(0)],
          ['316254', '호남2', '관리수수료', ...Array(24).fill(0)]
        ];
