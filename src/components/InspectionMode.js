...
const INSPECTION_TABS = {
  GENERAL: {
    ...
    ADDITIONAL: {
    label: '추가검수항목',
    items: ['유플레이 유치검수', 'V컬러링 음악감상 플러스 유치', '폰교체 패스 유치', '폰교체 슬림 유치', '폰 안심패스 유치', '통화연결음 유치', '청소년요금제추가정책(1)유치', '청소년요금제추가정책(2)유치', '유통망지원금 활성화정책']
  },
  DEDUCTION: {
    label: '차감검수항목',
    items: ['유플레이 미유치 검수', '통화연결음 미유치', '보험 미유치', '115군 선택약정 차감', '선택약정 S721(010신규) 차감', '선택약정 S931,S938,S937(MNP) 차감', '선택약정 아이폰16류전체(MNP) 차감', 'A166 44군 대상외요금제(MNP) 차감', 'A166 44군 대상외요금제(기변) 차감', '정책기변 차감', '기변 C타겟 차감', '33군미만, 시니어1군시 차감', '온세일 전략온라인POS 차감']
  }
};
